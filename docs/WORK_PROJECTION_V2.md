...
Activation requires a separately governed overlay projection, V2 hosted runtime
configuration, and workflow/provider selection. The shared pipeline has dormant
profile-conditional V2 dispatch and CAS retry isolation; its active and inactive
