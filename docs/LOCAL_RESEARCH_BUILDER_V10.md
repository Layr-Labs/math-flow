...
5. extend the completed exact V10 scoped miniature so its precommitted work
   responses pass through the public V2 request/bundle path, then run semantic
   knowledge-plus-work judges before considering a production projection.
