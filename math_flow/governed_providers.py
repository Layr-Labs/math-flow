        ...
        *,
        ...
        def retry_feedback(exc: Exception, attempt: int) -> str:
            ...
            return (
                ...
                "- Every contentOperation uses its own entity guard: a new entity ID "
                "uses baseDigest null; an existing entity ID copies that entity's "
                "exact digest from baseState, never baseState.stateDigest. Audit "
                "every contentOperation, and do not update existing entities when "
                "merely referencing them from contribution.\n"
                ...
                "relatedProgramIds.\n"
                "- Once there are at least two contributions, they may not all remain "
                "directly at root.\n"
